...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/M41NUL/mainul-approval.txt/blob/main/mainul.approval.txt"])
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/M41NUL/mainul-approval.txt/blob/main/mainul.approval.txt')
			if basesplit in plr:
				key = basesplit
